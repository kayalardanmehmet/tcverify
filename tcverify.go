...
type ResponseForeign struct {
	TCKimlikNoDogrulaResult string `xml:"Body>YabanciKimlikNoDogrulaResponse>YabanciKimlikNoDogrulaResult"`
}
...
func CheckForeign(ID string, name string, surname string, birthDay string, birthMonth string, birthYear string) (bool, error) {
	rawXml := []byte(`<?xml version="1.0" encoding="utf-8"?>
		<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
			<soap:Body>
	...
	client := &http.Client{}
	req, err := http.NewRequest("POST", "https://tckimlik.nvi.gov.tr/Service/KPSPublicYabanciDogrula.asmx", bytes.NewBuffer(rawXml))
	if err != nil {
		return false, err
	}
	req.Header.Add("Content-Type", "text/xml; charset=utf-8")
	req.Header.Add("SOAPAction", "http://tckimlik.nvi.gov.tr/WS/YabanciKimlikNoDogrula")
	req.Header.Add("Host", "tckimlik.nvi.gov.tr")
	resp, err := client.Do(req)
	if err != nil {
		return false, err
